...
const SinglePost = (props) => {
  ...
  const postStyle = {
    ...
    background: "linear-gradient(180deg, rgba(16, 29, 51, 0.9) 0%, rgba(12, 22, 38, 0.9) 68.75%)", 
  };

  return (
    <div className="flex rounded border border-white hover:text-[#CD2147] transition flex-col md:flex-row">
      ...
      <div className="flex flex-col md:w-1/2 p-3 rounded mt-3 md:mt-0">
        <div className="card-header mb-3 flex flex-col justify-between border-white">
          <NavLink onClick={handleNavLinkClick} to={`/p/${props.SlugUrl}`}>
