...
const Services = () => {
  ...
  return (
    <div id="projects" className="services container mx-auto mb-20 mt-20">
      <h2 className="bg-black p-2 text-white rounded text-center text-4xl font-semibold mb-10 tracking-wider">
        HİZMETLERİMİZ
      </h2>
