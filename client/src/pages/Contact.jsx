...
const ContactForm = () => {
  useDocumentTitle("HEPİSTE - İletişim");
  ...
  const handleSubmit = async (e) => {
    ...
    const sendContact = async () => {
      const response = await fetch(
        `${process.env.REACT_APP_API_URL}/api/client/contact`,
        {
          method: "POST",
          ...
          body: JSON.stringify({
            ...
            email,
            subject,
            projectDetail: DOMPurify.sanitize(projectDetail),
          }),
        }
      );
      ...
      <div className="contact bg-gray-400 bg-opacity-60 p-8 rounded-lg shadow-md container mx-auto mt-10 mb-10">
        ...
        <div className="contact-body mt-4">
          <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4">
            ...
            <div className="flex flex-col">
              <label htmlFor="telefon" className="text-sm font-semibold mb-1">
            ...
            <div className="flex flex-col">
              <label htmlFor="subject" className="text-sm font-semibold mb-1">
                Konu
              </label>
              <input
                type="text"
            ...
            <div className="flex flex-col">
              <label htmlFor="subjectt" className="text-sm font-semibold mb-1">
            ...
            <button
              type="submit"
              className="bg-[#CD2147] text-white py-2 px-4 rounded-md focus:outline-none focus:ring focus:border-blue-300"
            >
              Gönder
            </button>
          </form>
